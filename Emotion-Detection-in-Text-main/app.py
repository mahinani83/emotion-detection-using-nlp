...
emotions_emoji_dict = {
    "anger": "😠",
    "boredom": "😒",   # Added emoji for boredom
    "empty": "😞",     # Added emoji for empty
    "enthusiasm": "🎉", # Added emoji for enthusiasm
    "fun": "😄",       # Added emoji for fun
    "happiness": "🤗",
    "hate": "💔",      # Added emoji for hate
    "love": "❤️",      # Added emoji for love
    "neutral": "😐",
    "relief": "😌",    # Added emoji for relief
    "sadness": "😔",
    "surprise": "😮",
    "worry": "😟"      # Added emoji for worry
}
